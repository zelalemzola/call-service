...
export default function Hero(){
    return(
        <div className='flex items-center flex-col justify-center gap-6 h-screen relative px-6 md:px-20'>
            <h1 className='text-3xl md:text-6xl font-bold md:font-medium text-[#141414] text-center z-20'>Comprehensive <span className='text-primary '>Call Center</span><br/>Solutions for your Business.</h1>
